      ...
      <div className="gallery_container">
        <div className="gallery_container-line1">
          ...
          <section className="gallery_grid-sect1">
            <h2 className="gallery_grid-sect1-title">your day at the gallery</h2>
            <p className="gallery_grid-sect1-content">Wander through our distinct collections and find new insights about our artists. Dive into the details of their creative process.</p>
          </section>
        </div>
        ...
        <div className="gallery_container-line2">
          ...
          <section className="gallery_grid-sect2">
            ...
            <p className="gallery_grid-sect2-content">We’re excited to welcome you to our gallery and see how our collections influence you.</p>
          </section>
        </div>
      </div>
